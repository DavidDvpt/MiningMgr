...
namespace WpfApp
{
    public class CmdWithoutParam : ICommand
    {
        ...
        public CmdWithoutParam(Action executeMethod)
        {
            _TargetExecuteMethod = executeMethod;
        }

        //constructeur avec "canExecute"
        public CmdWithoutParam(Action executeMethod, Func<bool> canExecuteMethod)
        {
            _TargetExecuteMethod = executeMethod;
